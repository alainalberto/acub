...
<body>
                                ...
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h3 class="m-b-0">50%</h3><span>Search Traffic</span></div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                    <!-- Column -->
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h3 class="m-b-0">30%</h3><span>Referal Traffic</span></div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                    <!-- Column -->
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h3 class="m-b-0">10%</h3><span>Social Media</span></div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                    <!-- Column -->
                                    <div class="col-sm-12 col-md-6 col-lg-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <h3 class="m-b-0">10%</h3><span>Direct Media</span></div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row m-t-30 m-b-15">
                                    ...
                                    <div class="col-4 birder-right text-left">
                                        <h4 class="m-b-0">60%<small><i class="ti-arrow-up text-success"></i></small></h4>Desktop</div>
                                    <!-- column -->
                                    <div class="col-4 birder-right text-center">
                                        <h4 class="m-b-0">28%<small><i class="ti-arrow-down text-danger"></i></small></h4>Mobile</div>
                                    <!-- column -->
                                    <div class="col-4 text-right">
                                        <h4 class="m-b-0">12%<small><i class="ti-arrow-up text-success"></i></small></h4>Tablet</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="js/pages/dashboards/dashboard2.js"></script>
</body>
